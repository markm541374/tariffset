...
An example of the heating profile produced is shown in figure \cite{quadtemp}. The tariff is a cubic spline fitted to nine support points and clearly causes the initial load required to heat the house in the morning has been shifted earlier to avoid the rising slope of the tariff at that time.
